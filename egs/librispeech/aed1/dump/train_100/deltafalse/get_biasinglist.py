...
dictionary = {}
# Change it to your path to bpe_dict_word_unigram${nbpe}suffix file
...
with open('../../../data/Biasing/Librispeech_unigram{}suffix/rareword_f15.txt'.format(nbpe)) as fin:
    rarewords = {}
    for line in fin:
...
with open('data_unigram{}suffix_KB.json'.format(nbpe), 'w') as fout:
