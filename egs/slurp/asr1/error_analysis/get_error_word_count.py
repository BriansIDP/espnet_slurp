...
freqlist = {}
with open("/home/gs534/rds/hpc-work/work/transformers/examples/pytorch/language-modeling/SLURP_data/KB/wordfreq.txt") as fin:
    for line in fin:
        word, freq = line.split()
        freqlist[word.upper()] = int(freq)

with open("/home/gs534/rds/hpc-work/work/slurp/data/KBs/SLURPKB/rarewords_ontology_f30.txt") as fin:
    rareset = set()
    for line in fin:
