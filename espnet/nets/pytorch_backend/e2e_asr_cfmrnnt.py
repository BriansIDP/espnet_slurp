...
from espnet.nets.pytorch_backend.transducer.arguments import add_arguments_conformer_encoder_common
from espnet.nets.pytorch_backend.e2e_asr_transducer import E2E as E2ERNNT
...
class E2E(E2ERNNT):
    ...
    def add_arguments(parser):
        ...
        E2ERNNT.decoder_add_general_arguments(parser)
        E2ERNNT.decoder_add_rnn_arguments(parser)
        E2ERNNT.decoder_add_custom_arguments(parser)

        E2ERNNT.training_add_custom_arguments(parser)
        E2ERNNT.transducer_add_arguments(parser)
        E2ERNNT.auxiliary_task_add_arguments(parser)
        return parser
    ...
    def forward_encoder(self, xs_pad, ilens):
        """Forward front-end and encoder, different from LSTM RNNT."""
