...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Percentage of entire dataset to decode"
    )
    ...
    parser.add_argument(
        "--use-ema", default=True, type=strtobool, help="Use EMA params if available."
    )
    # search related
    parser.add_argument("--nbest", type=int, default=1, help="Output N-best hypotheses")
    parser.add_argument("--beam-size", type=int, default=1, help="Beam size")
    parser.add_argument("--penalty", type=float, default=0.0, help="Insertion penalty")
    parser.add_argument("--coverage-penalty", type=float, default=0.0, help="Coverage penalty")
    parser.add_argument("--eos-max-logit-delta", type=float, default=5.0,
                        help="""Allow </s> to terminate a hyp only if its logit is no more than than
                                        this value away from the logit of the best candidate.""")
    parser.add_argument(
        "--maxlenratio",
        type=float,
        default=0.0,
    ...
    # Additional RNNLM arguments
    parser.add_argument("--rnnlm-layer", type=int, default=0, help="RNNLM layers")
    parser.add_argument("--rnnlm-unit", type=int, default=0, help="RNNLM layer width")
    parser.add_argument("--embed-unit", type=int, default=0, help="RNNLM embed size")
    parser.add_argument(
        "--external",
        type=strtobool,
        nargs="?",
    ...
    # Word-level LM arguments
    parser.add_argument(
        "--select",
        type=strtobool,
        nargs="?",
        default=False,
        help="Use LM for auto-KB selection",
    )
    parser.add_argument("--topk", type=int, default=500, help="select top k words")
    parser.add_argument(
        "--sel-lm", type=str, default=None, help="LM model file for selection"
    )
    parser.add_argument(
        "--nbestKB",
        type=strtobool,
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=False,
        help="Use class RNNLM",
    )
    parser.add_argument(
        "--classfile", type=str, default=None, help="Entity classification file for selection"
    )
    parser.add_argument(
